        ...
        <Container>
          <Row className='d-flex justify-content-evenly'>
            <Col sm={4} className='mb-5'>
              <Card.Img className='img-fluid' height={400} width={800} src={Airplane} alt='logo LiburinAja' data-aos={'fade-right'} />
            </Col>
            <Col sm={6} className='pt-lg-5' data-aos={'fade-left'}>
              <div>
                <h2>Tentang LiburinAja</h2>
                <p>
                  {/* LiburinAja is a platform that is able to provide information to tourists to search for tourism and buy tourist tickets in
                  ...
                  LiburinAja adalah sebuah platform yang mampu memberikan informasi kepada wisatawan untuk mencari wisata dan membeli tiket
          ...
          <Row className='d-flex justify-content-evenly'>
            ...
            <Col sm={6} className='pt-lg-5' data-aos={'fade-left'}>
              <div>
                <h2>Bagaimana cara menggunakan LiburinAja?</h2>
                <p>
                  {/* When opening the LiburinAja website for the first time, users will be directed to the home page which contains an
                  explanation of tourism features and articles on the website, and users can only see the home page, articles, tourism, and
                  about us the first time they open the LiburinAja website. so that users can buy tickets and open the my booking page, the
                  user is required to register and log in first so that users can buy tickets and open the mybooking page */}
                  Saat membuka website LiburinAja untuk pertama kalinya, pengguna akan diarahkan ke halaman home yang berisi penjelasan
                  fitur wisata dan artikel pada website, dan pengguna hanya dapat melihat halaman home, artikel, wisata, dan tentang kami
                  pada saat pertama kali membuka website LiburinAja. Jadi, jika pengguna ingin membeli tiket dan membuka halaman pesanan
                  saya, pengguna diwajibkan untuk mendaftar dan login terlebih dahulu sehingga pengguna dapat membeli tiket dan membuka
